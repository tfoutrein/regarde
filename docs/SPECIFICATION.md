...
>
> **L'écart demandé/obtenu ne se lit pas de la même façon selon l'écran.** Sur un écran animé, c'est la mesure directe de ce que B1 aurait coûté, et le seuil est un intervalle d'encodage (66,7 ms à 15 fps) : c'est le chiffre de C11. Sur un écran immobile, le même nombre est l'ÂGE de la dernière image encodée, et son contenu est exact puisque rien n'avait changé — 652 ms y sont normaux. Le journal les rapporte sur deux lignes distinctes ; les confondre a failli faire corriger une capture qui était juste.
